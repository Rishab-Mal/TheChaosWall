...
class SafeBufferedParquetWriter:
    ...
    def insert_table(self, table: pa.Table):
        """
        Write a pre-built pa.Table directly as a row group.
        Flushes any buffered rows first.
        """
...
def get_pendulum_schema():
    """
    Returns schema for double pendulum dataset.
    Includes g, initial angles in degrees, and label
    for the visualization / energy-check scripts.
    """
    return pa.schema([
        ...
        pa.field("init_theta1_deg", pa.float64()),
        pa.field("init_theta2_deg", pa.float64()),
...
if __name__ == "__main__":
    ...
    for i in range(25_000):
        row = (
            ...
            0.0,                 # theta1_dot
            0.0,                 # theta2_dot
            28.65,               # init_theta1_deg
            57.30,               # init_theta2_deg
            1.0,                 # l1
            1.0,                 # l2
            1.0,                 # m1
            1.0,                 # m2
